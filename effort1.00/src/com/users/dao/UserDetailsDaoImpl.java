...
public class UserDetailsDaoImpl extends JdbcDaoSupport implements UserDetailsDao {
	...
	private static final String SQL_USER_ATTEMPTS_RESET_ATTEMPTS = "UPDATE USER_ATTEMPTS SET attempts = 0, lastmodified = sysdate WHERE username = ?";
			...
			UserAttempts userAttempts = getJdbcTemplate().queryForObject(SQL_USER_ATTEMPTS_GET,
					new Object[] { username }, new RowMapper<UserAttempts>() {
						public UserAttempts mapRow(ResultSet rs, int rowNum) throws SQLException {
							...
							user.setLastModified(new java.util.Date(rs.getTimestamp("lastModified").getTime()));
							return user;
						}
